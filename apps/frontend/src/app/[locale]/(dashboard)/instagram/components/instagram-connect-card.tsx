...
export function InstagramConnectCard({ onConnect, requiresReauth }: Props) {
  return (
    <Card
      className={requiresReauth ? "border-amber-200 dark:border-amber-800" : ""}
    >
      <CardHeader>
      ...
      <CardContent className="space-y-4">
          ...
          <div className="flex items-start gap-3 rounded-lg border border-amber-200 bg-amber-50 p-3 dark:border-amber-800 dark:bg-amber-950/20">
            ...
            <div>
              ...
              <p className="text-xs text-amber-700 dark:text-amber-300">
                Your access token has expired or permissions were revoked.
        ...
        <div className="space-y-2">
          <p className="text-sm">
            Connect your Instagram Professional (Business or Creator) account
            to:
          </p>
        ...
        <div className="bg-muted/50 rounded-lg border p-3">
          <p className="text-muted-foreground text-xs">
            <strong>Requirements:</strong> You need an Instagram Professional
            account (Business or Creator). Personal accounts are not supported
            by Instagram's Messaging API.
          </p>
        </div>
      </CardContent>
    </Card>
