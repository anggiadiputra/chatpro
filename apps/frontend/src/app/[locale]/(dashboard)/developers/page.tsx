        ...
        <div className="flex flex-wrap items-end justify-between gap-2">
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              Integrate KirimChat with your applications using our API and webhooks
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Link href="/developers/api-keys">
            <Card className="hover:bg-accent transition-colors cursor-pointer h-full">
              ...
              <CardContent>
                <p className="text-muted-foreground text-sm">
                  Generate API keys to authenticate requests to the KirimChat Public API.
                  Use Bearer token authentication to send messages, manage contacts, and more.
                </p>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link href="/developers/webhooks">
            <Card className="hover:bg-accent transition-colors cursor-pointer h-full">
              ...
              <CardContent>
                <p className="text-muted-foreground text-sm">
                  Set up webhook endpoints to receive instant notifications when events occur,
                  such as incoming messages, delivery status, and read receipts.
                </p>
              </CardContent>
            </Card>
          </Link>
  ...
  "data": {
    ...
    "media_url": null
              ...
              <AccordionItem value="webhook-security">
                <AccordionTrigger>Webhook Security (HMAC Signatures)</AccordionTrigger>
                <AccordionContent className="space-y-3">
                  <p className="text-muted-foreground">
                  ...
                  <Alert>
                    <AlertDescription>
                      <strong>Important:</strong> Always verify the webhook signature before processing events
                      to ensure they came from KirimChat.
                    </AlertDescription>
                  </Alert>
                  ...
                  <div className="space-y-2">
                    ...
                    <ol className="text-muted-foreground list-inside list-decimal space-y-1 text-sm">
                      ...
                      <li>Calculate HMAC-SHA256 hash using the secret and body</li>
                      <li>Compare with the <code className="bg-muted rounded px-1">X-Webhook-Signature</code> header</li>
                    </ol>
                  </div>

                  <p className="text-muted-foreground text-sm font-medium">Example (Node.js):</p>
                  <CodeBlock
                    language="javascript"
...
app.post('/webhook', express.raw({ type: 'application/json' }), (req, res) => {
  ...
  res.status(200).send('OK');
              ...
              <AccordionItem value="api-authentication">
                ...
                <AccordionContent className="space-y-3">
                  <p className="text-muted-foreground">
                    Use Bearer token authentication with your API key to make requests to the KirimChat Public API.
                  </p>
                  ...
                  <Alert>
                    <AlertDescription>
                      <strong>Important:</strong> Keep your API keys secure. Never commit them to version control
              ...
              <AccordionItem value="send-message">
                ...
                <AccordionContent className="space-y-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <CodeBlock
                      code={`POST /api/v1/public/messages/send`}
                    />
                  </div>
...
Content-Type: application/json`}
                  ...
                  <div className="space-y-2">
                    <p className="font-medium">Request Body (WhatsApp Text Message):</p>
                    <CodeBlock
                      code={`{
  ...
  "content": "Hello! How can I help you today?"
                  ...
                  <div className="space-y-2">
                    <p className="font-medium">Request Body (Instagram Text Message):</p>
                    <CodeBlock
                      code={`{
  "customer_id": "cust_abc123",
  "channel": "instagram",
  ...
  "data": {
    ...
    "timestamp": "2025-11-27T10:30:00.000Z"
                  ...
                  <div className="space-y-2">
                    ...
                    <ul className="text-muted-foreground list-inside list-disc space-y-1 text-sm">
                      <li><strong>WhatsApp:</strong> text, image, document, audio, video, template</li>
                      <li><strong>Instagram:</strong> text, image, media_share</li>
                    </ul>
                  </div>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="error-handling">
                ...
                <AccordionContent className="space-y-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <ul className="text-muted-foreground list-inside list-disc space-y-1 text-sm">
                      <li><code className="bg-muted rounded px-1">400</code> - Bad Request (validation error)</li>
                      <li><code className="bg-muted rounded px-1">401</code> - Unauthorized (invalid API key)</li>
                      <li><code className="bg-muted rounded px-1">403</code> - Forbidden (permission denied)</li>
                      <li><code className="bg-muted rounded px-1">404</code> - Not Found (resource not found)</li>
                      <li><code className="bg-muted rounded px-1">429</code> - Too Many Requests (rate limit exceeded)</li>
                      <li><code className="bg-muted rounded px-1">500</code> - Internal Server Error</li>
                    </ul>
                  </div>
              ...
              <AccordionItem value="n8n-installation">
                ...
                <AccordionContent className="space-y-3">
                  <div className="space-y-2">
                    ...
                    <ol className="text-muted-foreground list-inside list-decimal space-y-1 text-sm">
                      <li>Go to <strong>Settings &gt; Community Nodes</strong></li>
                      <li>Select <strong>Install</strong></li>
                      <li>Enter <code className="bg-muted rounded px-1">@kichat/n8n-nodes-kirimchat</code> and confirm</li>
                    </ol>
                  </div>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="n8n-credentials">
                ...
                <AccordionContent className="space-y-3">
                  ...
                  <ol className="text-muted-foreground list-inside list-decimal space-y-1 text-sm">
                    ...
                    <li>Click <strong>Create API Key</strong> and copy the key (shown only once)</li>
                    <li>In n8n, create new credentials for <strong>KirimChat API</strong></li>
                    <li>Paste your API key (starts with <code className="bg-muted rounded px-1">kc_live_</code>)</li>
                  </ol>
                  <Alert className="mt-3">
                    <AlertDescription>
                      <strong>Tip:</strong> You can create an API key directly from the{" "}
