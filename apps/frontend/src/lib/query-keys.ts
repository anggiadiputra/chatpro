...
export const queryKeys = {
  ...
  dashboard: {
    ...
    messageVolume: (days: number) =>
      [...queryKeys.dashboard.all, 'message-volume', { days }] as const,
    customerInsights: () =>
      [...queryKeys.dashboard.all, 'customer-insights'] as const,
    qualityMetrics: () =>
      [...queryKeys.dashboard.all, 'quality-metrics'] as const,
  },
  ...
  templates: {
    ...
    list: (filters: { page?: number; search?: string; wabaId?: string }) =>
  ...
  insights: {
    ...
    byDateRange: (startDate: string, endDate: string) =>
      [...queryKeys.insights.all, { startDate, endDate }] as const,
  },
  ...
  messages: {
    ...
    list: (filters: { wabaId?: string; customerId?: string }) =>
