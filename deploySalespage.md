...
| **Path Domain Web** | `/home/whoops-app/htdocs/whoops.web.id` |
...
Buat file environment di folder target domain `/home/whoops-app/htdocs/whoops.web.id/.env`:

```bash
cat << 'EOF' > /home/whoops-app/htdocs/whoops.web.id/.env
# APP CONFIGURATION
...
chmod +x /home/whoops-app/deploy-salespage.sh
```

**Setiap kali Anda ingin deploy update sales page terbaru, cukup jalankan:**
```bash
/home/whoops-app/deploy-salespage.sh
```
